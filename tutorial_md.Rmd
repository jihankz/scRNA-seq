...
pbmc.data <- Read10X(data.dir = "filtered_gene_bc_matrices-20260219T031717Z-1-001/filtered_gene_bc_matrices/hg191")
...
saveRDS(pbmc, file = "/Users/Jihan/Intern/scRNA-seq")
```
***
...
ggsave(filename = "/Users/Jihan/Intern/scRNA-seq/pbmc3k_umap.jpg", height = 7, width = 12, plot = plot, quality = 50)
```
```{r save.rds, eval=FALSE}
saveRDS(pbmc, file = "/Users/Jihan/Intern/scRNA-seq/pbmc3k_final.rds")
```
```{r save2, include = FALSE}
saveRDS(pbmc, file = "/Users/Jihan/Intern/scRNA-seq/pbmc3k_final.rds")
```
```{r save.times, include = FALSE}
write.csv(x = t(as.data.frame(all_times)), file = "/Users/Jihan/Intern/scRNA-seq/pbmc3k_tutorial_times.csv")
```
<details>
